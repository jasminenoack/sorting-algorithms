...
(function (SortComp) {
    ...
    var boardList = [];
    // setup size dropdown
    var sizes = sizes_1.Sizes.sizeList;
    ...
    // set up shuffles
    var orders = shuffles_1.Shuffles.ShuffleList;
    ...
    // set up value types
    var valueTypes = valueTypes_1.ValueTypes.valueTypeList;
    ...
    createButton.addEventListener('click', function () {
        ...
        var board = new board_1.Boards.Board(size, order, value);
        boardList.push({
            board: board,
            sort: new Sort(board)
        });
        index_1.Index.createBoard(boardList.length - 1, Sort, boardList, boxHeight, boxWidth, boardsElement);
    });
    var stepElement = document.getElementById("step");
    var boundStep = index_1.Index.step.bind(null, boardList, boxHeight, boxWidth, boardsElement);
    stepElement.addEventListener('click', boundStep);
    index_1.Index.createDelegatedEvent(boardsElement, 'click', function (event, target) {
        var wrapperElement = index_1.Index.closestParent(target, '.wrapper');
    ...
    index_1.Index.createDelegatedEvent(boardsElement, 'click', function (event, target) {
        ...
        item.sort.reset();
        index_1.Index.reRenderBoard(wrapperIndex, item.sort.constructor, boardList, boxHeight, boxWidth, boardsElement);
    }, '.reset');
    ...
    autoElement.addEventListener('click', function (event) {
        if (autoInterval) {
            ...
            var boundStep_1 = index_1.Index.step.bind(null, boardList, boxHeight, boxWidth, boardsElement);
...
Object.defineProperty(exports, "__esModule", { value: true });
var baseSort_1 = __webpack_require__(11);
...
Object.defineProperty(exports, "__esModule", { value: true });
var baseSort_1 = __webpack_require__(11);
var gnome_1 = __webpack_require__(15);
