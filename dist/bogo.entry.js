...
var Bozo;
(function (Bozo) {
    var element = document.getElementById('bozo');
    var boardList = [];
    var size = Sizes._25;
    var valueType = new ValueTypes.Integer();
    var shuffle = new Shuffles.RandomShuffle();
    var board = new Boards.Board(size, shuffle, valueType, Boards.Verbosity.None);
    var sort = new Sorts.BogoSingle(board);
    boardList.push({
        board: board,
        sort: sort
    });
    Index.createBoard(boardList.length - 1, sort.constructor, boardList, boxHeight, boxWidth, element);
    Index.autoRunBoards(boardList, boxHeight, boxWidth, element, delay, delayOnComplete);
})(Bozo || (Bozo = {}));
var Permutation;
(function (Permutation) {
    var element = document.getElementById('permutation');
    var boardList = [];
    var size = Sizes._25;
    var valueType = new ValueTypes.Integer();
    var shuffle = new Shuffles.RandomShuffle();
    var board = new Boards.Board(size, shuffle, valueType, Boards.Verbosity.None);
    var sort = new Sorts.Permutation(board);
    boardList.push({
        board: board,
        sort: sort
    });
...
var Smart;
(function (Smart) {
    var element = document.getElementById('smart-bozo');
    var boardList = [];
    var size = Sizes._25;
    var valueType = new ValueTypes.Integer();
    var shuffle = new Shuffles.RandomShuffle();
    var board = new Boards.Board(size, shuffle, valueType, Boards.Verbosity.None);
    var sort = new Sorts.BogoSingleCompare(board);
    boardList.push({
        board: board,
        sort: sort
    });
...
var Bogobogo;
(function (Bogobogo) {
    var element = document.getElementById('bogobogo');
    var boardList = [];
    var size = Sizes._25;
    var valueType = new ValueTypes.Integer();
    var shuffle = new Shuffles.RandomShuffle();
    var board = new Boards.Board(size, shuffle, valueType, Boards.Verbosity.None);
    var sort = new Sorts.Bogobogo(board);
    boardList.push({
        board: board,
        sort: sort
    });
